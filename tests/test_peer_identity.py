...
from tests._certs import SYNTHETIC, Material, _issued, _self_signed, _write
...
# ------------------------------------------------------------------ synthetic PKI
# The cert-generation primitives (_key, _subject, _window, _self_signed, _issued,
# Material, _write) live in tests/_certs.py -- extracted there when the connector
# preflight tests needed the same thing, so there is one generator rather than two.
